...
<html lang="en" class="light-style customizer-hide" dir="ltr" data-theme="theme-default" data-assets-path="{{asset('assets-front')}}/"
  data-template="vertical-menu-template-free">



@extends('front.partials.headAuth')
...
<body>
 ...
 @include('front.partials.footerAuth')
